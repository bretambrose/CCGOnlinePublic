...
CProcessBaseTester::CProcessBaseTester( CProcessBase *process ) :
	ManagerProxy( IP::Make_Shared< CProcessMailbox >( MEMORY_TAG, EProcessID::CONCURRENCY_MANAGER, MANAGER_PROCESS_PROPERTIES ) ),
	SelfProxy( IP::Make_Shared< CProcessMailbox >( MEMORY_TAG, AI_PROCESS_ID, process->Get_Properties() ) )
{
...
void CProcessBaseTester::Log( const IP::String &log_string )
{
	CProcessStatics::Set_Current_Process( Get_Process() );
...
const IP::UniquePtr< CProcessMessageFrame > &CProcessBaseTester::Get_Log_Frame( void ) const 
{ 
	return Get_Process()->LogFrame; 
}

const IP::UniquePtr< CProcessMessageFrame > &CProcessBaseTester::Get_Manager_Frame( void ) const 
{ 
...
const IP::UniquePtr< CProcessMessageFrame > &CProcessBaseTester::Get_Frame( EProcessID id ) const
{
