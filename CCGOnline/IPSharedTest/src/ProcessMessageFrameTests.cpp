...
TEST( VirtualProcessMessageFrameTests, Add_Remove )
{
	...
	message_frame.Add_Message( IP::Make_Const_Process_Message< CLogRequestMessage >( MEMORY_TAG, MANAGER_PROCESS_PROPERTIES, LOG_MESSAGES[ 0 ] ) );
	message_frame.Add_Message( IP::Make_Const_Process_Message< CLogRequestMessage >( MEMORY_TAG, MANAGER_PROCESS_PROPERTIES, LOG_MESSAGES[ 1 ] ) );
