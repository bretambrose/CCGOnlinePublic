...
#include <IPShared/TaskScheduler/ScheduledTaskPolicies.h>
...
CTaskScheduler::CTaskScheduler( void ) :
	TaskQueue( IP::Make_Unique< IP::Algorithm::TPriorityQueue< std::shared_ptr< CScheduledTask >, CScheduledTaskMovementPolicy, CScheduledTaskComparator > >( MEMORY_TAG ) ),
	TimeGranularity( 0.0 )
{
}
