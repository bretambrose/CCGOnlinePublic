...
namespace StructuredExceptionHandler
{
	...
	IPSHARED_API void Initialize( void );
	IPSHARED_API void Initialize( const DExceptionHandler &handler );

	IPSHARED_API void Shutdown( void );

} // namespace StructureExceptionHandler
} // namespace Exception
} // namespace Debug
} // namespace IP