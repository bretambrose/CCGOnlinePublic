...
IPSHARED_API class CSlashCommandDefinition
{
	public:
		...
		const std::regex &Get_Param_Match_Expression( void ) const { return ParamMatchExpression; }
	...
	private:
		...
		std::regex ParamMatchExpression;
};
