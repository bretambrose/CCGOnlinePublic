...
IPDATABASE_API class IDatabaseConnection
{
	public:

		virtual ~IDatabaseConnection() {}

		virtual void Initialize( const IP::String &connection_string ) = 0;
		virtual void Shutdown( void ) = 0;

		virtual DBConnectionIDType Get_ID( void ) const = 0;

		virtual IDatabaseStatement *Allocate_Statement( const IP::String &statement_text ) = 0;
		...
		virtual void Construct_Statement_Text( IDatabaseTask *task, IDatabaseVariableSet *input_parameters, IP::String &statement_text ) const = 0;
