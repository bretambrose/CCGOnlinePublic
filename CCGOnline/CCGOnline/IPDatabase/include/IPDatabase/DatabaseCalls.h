...
#include <IPDatabase/Interfaces/CompoundDatabaseTaskInterface.h>
...
IPDATABASE_API class CDatabaseTaskBase : public IDatabaseTask
{
	public:
...
IPDATABASE_API class CCompoundDatabaseTaskBase : public ICompoundDatabaseTask
{
	public:
	...
	protected:
		...
		using ChildSuccessHandlerFunctorType = std::function< void() >;
	...
	private:
		...
		using ChildTypeCallbackTableType = IP::UnorderedMap< Loki::TypeInfo, ChildSuccessHandlerFunctorType, STypeInfoContainerHelper >;
