...
IPSHARED_API class CTaskScheduler
{
	public:
	...
	private:
		...
		IP::UniquePtr< IP::Algorithm::TPriorityQueue< std::shared_ptr< CScheduledTask >, CScheduledTaskMovementPolicy, CScheduledTaskComparator > > TaskQueue;
