...
IPSHARED_API class CScheduledTask
{
	public:
...
std::shared_ptr< IP::Execution::CScheduledTask > Make_Scheduled_Task( const char *tag, Args &&...args )
{
	return IP::Make_Shared_Upcast< T, IP::Execution::CScheduledTask >( tag, std::forward< Args >( args )... );
}
