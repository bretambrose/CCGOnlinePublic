...
class CGetAllAccountsProcedureCall : public TDatabaseProcedureCall< CEmptyVariableSet, ISIZE, CGetAccountProcedureResultSet, OSIZE >
{
	public:
		...
		virtual const char *Get_Database_Object_Name( void ) const { return "dynamic.get_all_accounts"; }
	...
	private:
		...
		IP::Vector< CGetAccountProcedureResultSet > Accounts;
...
void Run_ReadSeedData_GetAllAccounts_OK_Test( uint32_t task_count )
{
	...
	IP::Vector< CGetAllAccountsProcedureCall< ISIZE, OSIZE > * > tasks;
...
{
	IDatabaseConnection *connection = CODBCFactory::Get_Environment()->Add_Connection( "Driver={SQL Server Native Client 11.0};Server=AZAZELPC\\CCGONLINE;Database=testdb;UID=testserver;PWD=TEST5erver#;", true );
	ASSERT_TRUE( connection != nullptr );
...
class CGetAllAccountsInOutParams : public CODBCVariableSet
{
	public:
		...
		CGetAllAccountsInOutParams( const IP::String &filtered_nickname, uint64_t in_test, uint64_t out_test ) :
			BASECLASS(),
...
class CGetAllAccountsInOutProcedureCall : public TDatabaseProcedureCall< CGetAllAccountsInOutParams, ISIZE, CGetAccountProcedureResultSet, OSIZE >
{
	public:
		...
		CGetAllAccountsInOutProcedureCall( const IP::String &filter_nickname, uint64_t in_test, uint64_t out_test ) : 
			BASECLASS(),
		...
		virtual const char *Get_Database_Object_Name( void ) const { return "dynamic.get_all_accounts_with_in_out"; }
...
template< uint32_t ISIZE, uint32_t OSIZE >
void Run_ReadSeedData_GetAllAccountsWithInOut_OK_Test( const IP::String &filtered_name, uint32_t task_count )
{
	IDatabaseConnection *connection = CODBCFactory::Get_Environment()->Add_Connection( "Driver={SQL Server Native Client 11.0};Server=AZAZELPC\\CCGONLINE;Database=testdb;UID=testserver;PWD=TEST5erver#;", false );
	ASSERT_TRUE( connection != nullptr );

	TDatabaseTaskBatch< CGetAllAccountsInOutProcedureCall< ISIZE, OSIZE > > db_task_batch;
	IP::Vector< CGetAllAccountsInOutProcedureCall< ISIZE, OSIZE > * > tasks;
	for ( uint32_t i = 0; i < task_count; ++i )
	{
...
{
	Run_ReadSeedData_GetAllAccountsWithInOut_OK_Test< 2, 2 >( IP::String( "Blah" ), 2 );
}

TEST_F( ODBCSuccessTests, ReadSeedData_GetAllAccountsWithInOut_OK_Test_BretFilter_2_2 )
{
	Run_ReadSeedData_GetAllAccountsWithInOut_OK_Test< 2, 2 >( IP::String( "Bret" ), 4 );
}
...
class CGetAccountCountParams : public CODBCVariableSet
{
	public:
		...
		CGetAccountCountParams( const IP::String &filtered_nickname ) :
			BASECLASS(),
			AccountCount(),
			FilteredNickname( filtered_nickname )
		{}
...
class CGetAccountCountFunctionCall : public TDatabaseFunctionCall< CGetAccountCountParams, ISIZE >
{
	public:
		...
		CGetAccountCountFunctionCall( const IP::String &filter_nickname ) : 
			BASECLASS(),
			FilterNickname( filter_nickname ),
			FinalCount( 0 ),
			FinishedCalls( 0 ),
		...
		virtual const char *Get_Database_Object_Name( void ) const { return "dynamic.get_account_count"; }
...
template< uint32_t ISIZE >
void Run_ReadSeedData_GetAccountCount_OK_Test( const IP::String &filtered_name, uint32_t task_count )
{
	IDatabaseConnection *connection = CODBCFactory::Get_Environment()->Add_Connection( "Driver={SQL Server Native Client 11.0};Server=AZAZELPC\\CCGONLINE;Database=testdb;UID=testserver;PWD=TEST5erver#;", false );
	ASSERT_TRUE( connection != nullptr );

	TDatabaseTaskBatch< CGetAccountCountFunctionCall< ISIZE > > db_task_batch;
	IP::Vector< CGetAccountCountFunctionCall< ISIZE > * > tasks;
	for ( uint32_t i = 0; i < task_count; ++i )
	{
...
{
	Run_ReadSeedData_GetAccountCount_OK_Test< 1 >( IP::String( "Blah" ), 1 );
}

TEST_F( ODBCSuccessTests, ReadSeedData_GetAccountCount_OK_Test_NoFilter_2_3 )
{
	Run_ReadSeedData_GetAccountCount_OK_Test< 2 >( IP::String( "Blah" ), 3 );
}

TEST_F( ODBCSuccessTests, ReadSeedData_GetAccountCount_OK_Test_BretFilter_3_7 )
{
	Run_ReadSeedData_GetAccountCount_OK_Test< 3 >( IP::String( "Bret" ), 7 );
}
...
class CGetAccountEmailFunctionCall : public TDatabaseFunctionCall< CGetAccountEmailFunctionParams, ISIZE >
{
	public:
		...
		virtual const char *Get_Database_Object_Name( void ) const { return "dynamic.get_account_email_by_id"; }
...
void Run_ReadSeedData_GetAccountEmail_OK_Test( uint64_t account_id, uint32_t task_count )
{
	...
	IP::Vector< CGetAccountEmailFunctionCall< ISIZE > * > tasks;
	for ( uint32_t i = 0; i < task_count; ++i )
	{
...
class CDoNothingProcedureCall : public TDatabaseProcedureCall< CEmptyVariableSet, ISIZE, CEmptyVariableSet, 1 >
{
	public:
		...
		virtual const char *Get_Database_Object_Name( void ) const { return "dynamic.do_nothing"; }
...
void Run_DoNothing_OK_Test( uint32_t task_count )
{
	...
	IP::Vector< CDoNothingProcedureCall< ISIZE > * > tasks;
	for ( uint32_t i = 0; i < task_count; ++i )
	{
...
class CTestBooleanDataProcedureCall : public TDatabaseProcedureCall< CTestBooleanDataParams, ISIZE, CTestBooleanDataResultSet, OSIZE >
{
	public:
		...
		virtual const char *Get_Database_Object_Name( void ) const { return "dynamic.test_boolean_data"; }
	...
	private:
		...
		IP::Vector< CTestBooleanDataResultSet > Results;
...
void Run_ReadSeedData_TestBooleanData_OK_Test( bool in, bool in_out, uint32_t task_count )
{
	...
	IP::Vector< CTestBooleanDataProcedureCall< ISIZE, OSIZE > * > tasks;
	for ( uint32_t i = 0; i < task_count; ++i )
	{
...
class CTestFPDataProcedureCall : public TDatabaseProcedureCall< CTestFPDataParams, ISIZE, CTestFPDataResultSet, OSIZE >
{
	public:
		...
		virtual const char *Get_Database_Object_Name( void ) const { return "dynamic.test_fp_data"; }
	...
	private:
		...
		IP::Vector< CTestFPDataResultSet > Results;
...
void Run_ReadSeedData_TestFPData_OK_Test( float float_in, double double_in, float float_in_out, double double_in_out, uint32_t task_count )
{
	...
	IP::Vector< CTestFPDataProcedureCall< ISIZE, OSIZE > * > tasks;
	for ( uint32_t i = 0; i < task_count; ++i )
	{
...
class CNullableFunctionParams : public CODBCVariableSet
{
	public:
		...
		CNullableFunctionParams( const IP::String &nickname ) :
			BASECLASS(),
			AccountID(),
			Nickname( nickname )
		{}
...
class CNullableFunctionCall : public TDatabaseFunctionCall< CNullableFunctionParams, ISIZE >
{
	public:
		...
		CNullableFunctionCall( const IP::String &nickname ) : 
			BASECLASS(),
			Nickname( nickname ),
		...
		virtual const char *Get_Database_Object_Name( void ) const { return "dynamic.get_account_by_nickname"; }
		...
		void Verify_Results( void ) 
		{
			...
			if ( AccountIDIsNull )
			{
				ASSERT_TRUE( _stricmp( Nickname.c_str(), "bret" ) != 0 && _stricmp( Nickname.c_str(), "peti" ) != 0 && _stricmp( Nickname.c_str(), "will" ) != 0 );
			}
			else
			{
				...
				{
					case 1:
						ASSERT_TRUE( _stricmp( Nickname.c_str(), "bret" ) == 0 );
						break;

					case 2:
						ASSERT_TRUE( _stricmp( Nickname.c_str(), "peti" ) == 0 );
						break;

					case 3:
						ASSERT_TRUE( _stricmp( Nickname.c_str(), "will" ) == 0 );
						break;
...
template< uint32_t ISIZE >
void Run_ReadSeedData_NullableFunction_OK_Test( uint32_t task_count, const IP::String &non_null_nickname, uint32_t null_index )
{
	IDatabaseConnection *connection = CODBCFactory::Get_Environment()->Add_Connection( "Driver={SQL Server Native Client 11.0};Server=AZAZELPC\\CCGONLINE;Database=testdb;UID=testserver;PWD=TEST5erver#;", false );
	ASSERT_TRUE( connection != nullptr );

	TDatabaseTaskBatch< CNullableFunctionCall< ISIZE > > db_task_batch;
	IP::Vector< CNullableFunctionCall< ISIZE > * > tasks;
	for ( uint32_t i = 0; i < task_count; ++i )
	{
		CNullableFunctionCall< ISIZE > *db_task = new CNullableFunctionCall< ISIZE >( ( i == null_index ) ? "dsfhjkfsjk" : non_null_nickname );
		tasks.push_back( db_task );
		db_task_batch.Add_Task( db_task );
	}
...
{
	Run_ReadSeedData_NullableFunction_OK_Test< 1 >( 1, "Bret", 1 );
}

TEST_F( ODBCSuccessTests, ReadSeedData_NullableFunctionTest_1_1_0 )
{
	Run_ReadSeedData_NullableFunction_OK_Test< 1 >( 1, "Peti", 0 );
}

TEST_F( ODBCSuccessTests, ReadSeedData_NullableFunctionTest_2_5_3 )
{
	Run_ReadSeedData_NullableFunction_OK_Test< 2 >( 5, "Will", 3 );
}

TEST_F( ODBCSuccessTests, ReadSeedData_NullableFunctionTest_2_5_4 )
{
	Run_ReadSeedData_NullableFunction_OK_Test< 2 >( 5, "Will", 4 );
}
...
class CNullableProcedureParams : public CODBCVariableSet
{
	public:
			...
			WStringInOut()
		{
			...
			if ( !wstring_null )
			{
				WStringInOut.Set_Value( "TestWString" );
			}
		}
...
class CNullableProcedureCall : public TDatabaseProcedureCall< CNullableProcedureParams, ISIZE, CNullableProcedureResultSet, OSIZE >
{
	public:
		...
		virtual const char *Get_Database_Object_Name( void ) const { return "dynamic.nullable_procedure"; }
	...
	private:
		...
		DBStringInOut< 32 > WStringOut;

		IP::Vector< CNullableProcedureResultSet > Results;
...
void Run_ReadSeedData_NullableProcedure_Test( uint32_t task_count, uint64_t null_account_id, bool string_null, bool wstring_null )
{
	...
	IP::Vector< CNullableProcedureCall< ISIZE, OSIZE > * > tasks;
	for ( uint32_t i = 0; i < task_count; ++i )
	{
...
class CSelectAccountDetailsTask : public TDatabaseSelect< CSelectAccountDetailsResultSet, OSIZE >
{
	...
	private:
		...
		IP::Vector< CSelectAccountDetailsResultSet > Results;
...
void Run_ReadSeedData_SelectAccountDetails_Test( uint32_t task_count )
{
	...
	IP::Vector< CSelectAccountDetailsTask< OSIZE > * > tasks;
	for ( uint32_t i = 0; i < task_count; ++i )
	{
...
class CTableValuedFunctionTask : public TDatabaseTableValuedFunctionCall< CTestTVFParams, ISIZE, CTestTVFResultSet, OSIZE >
{
	public:
		...
		virtual void Build_Column_Name_List( IP::Vector< const char * > &column_names ) const
		{
			...
			column_names.push_back( "product_key_desc" );
		}
	...
	private:
		...
		IP::Vector< CTestTVFResultSet > Results;
...
void Run_ReadSeedData_TableValueFunctionTest( uint32_t task_count, uint64_t account_id )
{
	...
	IP::Vector< CTableValuedFunctionTask< ISIZE, OSIZE > * > tasks;
	for ( uint32_t i = 0; i < task_count; ++i )
	{
...
void Run_TrivialCompoundTask_Test( uint32_t task_count )
{
	...
	IP::Vector< CTrivialCompoundTask< BATCH_SIZE, ISIZE1, OSIZE1 > * > tasks;
	for ( uint32_t i = 0; i < task_count; ++i )
	{
...
class CCompoundInsertProcedureCall : public TDatabaseProcedureCall< CCompoundInsertParams, ISIZE, CEmptyVariableSet, 1 >
{
	public:
		...
		virtual const char *Get_Database_Object_Name( void ) const { return "dynamic.test_compound_insert"; }
...
class CCompoundInsertTask : public TCompoundDatabaseTask< BATCH_SIZE >
{
	public:
		...
		{
			Register_Child_Type_Success_Callback( Loki::TypeInfo( typeid( Child1Type ) ), std::bind( &CCompoundInsertTask::On_Insert_Success, this ) );
		}
