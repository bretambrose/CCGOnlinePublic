...
IPDATABASE_API class CODBCEnvironment : public CODBCObjectBase, public IDatabaseEnvironment
{
	public:
		...
		virtual IDatabaseConnection *Add_Connection( const IP::String &connection_string, bool cache_statements );
	...
	private:
		...
		IP::UnorderedMap< DBConnectionIDType, IDatabaseConnection * > Connections;
