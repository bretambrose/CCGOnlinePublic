...
#include <IPDatabase/ODBCImplementation/ODBCEnvironment.h>
...
IDatabaseConnection *CODBCEnvironment::Add_Connection( const IP::String &connection_string, bool cache_statements )
{
	...
	IDatabaseConnection *connection = IP::New< CODBCConnection >( MEMORY_TAG, new_id, EnvironmentHandle, dbc_handle, cache_statements );
