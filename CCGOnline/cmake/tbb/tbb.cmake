...
elseif(PLATFORM_LINUX)
    ...
    ExternalProject_Add( tbb_src
            ...
            URL "${TBB_URL}"
            UPDATE_COMMAND ""
            PATCH_COMMAND patch ${TBB_SOURCE_DIR}/Makefile < ${CMAKE_SOURCE_DIR}/cmake/tbb/Makefile.patch
            CONFIGURE_COMMAND ""
            ...
            BUILD_IN_SOURCE 1
            INSTALL_COMMAND python ${CMAKE_SOURCE_DIR}/cmake/tbb/install.py --config ${TBB_BUILD_CONFIG} --dest ${EXTERNAL_PROJECT_DIR}/tbb
            CMAKE_ARGS
            )
elseif(PLATFORM_APPLE)
    # TODO: Add
...
foreach(TBB_LIB_NAME IN ITEMS ${TBB_LIBS})
    ...
    set_property(TARGET ${TBB_LIB_NAME} PROPERTY IMPORTED_LOCATION ${EXTERNAL_PROJECT_DIR}/tbb/lib/${PLATFORM_LIBRARY_PREFIX}${TBB_LIB_NAME}.${DYNAMIC_LIBRARY_SUFFIX})
endforeach()
...
include_directories(${EXTERNAL_PROJECT_DIR}/tbb/include)
